...
@Component({
    ...
    <mat-dialog-content>
      <form [formGroup]="form" class="dialog-form">
        ...
        <mat-form-field appearance="outline" class="w-full">
          ...
          <input matInput formControlName="nombre" placeholder="Ej: Empresa ABC" />
        ...
        <mat-form-field appearance="outline" class="w-full">
          ...
          <mat-hint>Solo minúsculas, números y guiones. No se puede cambiar después.</mat-hint>
          <mat-error *ngIf="form.get('slug')?.hasError('required')">Requerido</mat-error>
          <mat-error *ngIf="form.get('slug')?.hasError('pattern')">Solo minúsculas, números y guiones</mat-error>
        </mat-form-field>

        <mat-form-field appearance="outline" class="w-full">
          <mat-label>Grupo PRTG</mat-label>
          <input matInput formControlName="prtg_group" placeholder="Nombre exacto del grupo en PRTG" />
          <mat-hint>Debe coincidir exactamente con el nombre del grupo raíz en PRTG.</mat-hint>
          <mat-error *ngIf="form.get('prtg_group')?.hasError('required')">Requerido</mat-error>
        </mat-form-field>
  ...
  styles: [`
    ...
    .dialog-error {
      ...
      border-radius: 6px; color: #f44336; font-size: 13px;
    }
